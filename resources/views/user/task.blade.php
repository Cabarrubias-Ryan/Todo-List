    ...
    <div class="container mt-4 py-6 sm:px-6 lg:px-8">
        <div class="row px-2 py-6 sm:px-0">
            ...
            <div class="col text-center text-sm-end">
                <div>
                    <button type="button" class="btn btn-success rounded-pill" data-bs-toggle="modal" data-bs-target="#studentAddModal" style="font-size: 0.8rem">Add Task</button>
                </div>
            </div>
        </div>
...
<main class="mt-4">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col text-center">
                                        ...
                                        <!-- Delete Button -->
                                        <form action="{{ route('task.delete', $data->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
    ...
    <section class="modal fade @if($errors->any()) show @endif" id="studentAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
